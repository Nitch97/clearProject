...
#import "LYBottomPickView.h"
#import "AppDelegate.h"


@interface LYBottomPickView()<UIGestureRecognizerDelegate>

@end


@implementation LYBottomPickView
...
-(instancetype)initWithController:(UIViewController *)controller{
    ...
    if(self){
        ...
        //LHEditPickerView
        LYPickView *editView=[[LYPickView alloc]initWithFrame:CGRectMake(0, controller.view.bounds.size.height, controller.view.bounds.size.width, controller.view.bounds.size.height/5*2)];
...
+(instancetype)showWithController:(UIViewController *)controller andData:(NSArray *)data{
    LYBottomPickView *bottom=[[self alloc]initWithController:controller];
...
+(void)showEditPickerViewWithController:(UIViewController *)controller andData:(NSArray *)data andBlock:(void (^)(NSString *temp))bottomResultPresent{
    LYBottomPickView *bottom=[LYBottomPickView showWithController:controller andData:data];
