...
@interface LYPickView ()<UIPickerViewDelegate,UIPickerViewDataSource>
{
    //按钮的宽度
    CGFloat _btnWidth;
    NSString *_result;
...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if(self){
        ...
        [cancelbtn setTitleColor:LYMainColor forState:(UIControlStateNormal)];
        ...
        [sureBtn setTitleColor:LYMainColor forState:(UIControlStateNormal)];
